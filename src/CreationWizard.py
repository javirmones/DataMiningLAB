...
class CreationWizard():
    ...
    def create_dataframes(self):
        ...
        print(target_data_course_submodules_list)
    ...
    '''
        dates_per_course_query                  = self.db.query("SELECT o.course_id, d.from, d.to FROM objets AS o JOIN date AS d ON d.course_id = o.course_id")
        dates_per_course_list                   = [list(course_dates) for course_dates in dates_per_course_query]
        write_from_list("course_id,course_begin,course_end\n", dates_per_course_list, route_of.courses_dates) 
